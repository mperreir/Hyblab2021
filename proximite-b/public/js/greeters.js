function greeter_background(){
    ...
    if (persona == "jeune"){
        $('#greeter_content').css("background-image", "url('/proximite-b/img/greeter/sans_la_bulle_jeune.svg')");
        ...
        $('#greeter_content').css("background-image", "url('/proximite-b/img/greeter/sans_la_bulle_famille.svg')");
        ...
        $('#greeter_content').css("background-image", "url('/proximite-b/img/greeter/sans_la_bulle_senior.svg')");
